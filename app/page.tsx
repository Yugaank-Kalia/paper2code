      ...
      <div className="min-h-screen bg-background bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 text-xl text-muted-foreground tracking-tight">
            Automatically convert Computer Science, Math and Machine Learning papers into clean, executable code. Bridge the gap between research and implementation.
          </p>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Everything you need to convert papers to production-ready code</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardHeader className="text-center">
                <CardTitle className="text-4xl text-primary mb-2">500+</CardTitle>
                <CardDescription>Papers Converted</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader className="text-center">
                <CardTitle className="text-4xl text-primary mb-2">10K+</CardTitle>
                <CardDescription>Lines of Code Generated</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader className="text-center">
                <CardTitle className="text-4xl text-primary mb-2">50ms</CardTitle>
          ...
          <Card className="border-border max-w-6xl py-20">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg mb-8">
                Start converting papers to code today. No credit card required.
              </CardDescription>
